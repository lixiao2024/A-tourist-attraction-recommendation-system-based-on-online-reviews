...
/***/ 149:
/*!***************************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-icons/components/uni-icons/uniicons_file_vue.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 164:
/*!********************************************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-file-picker/components/uni-file-picker/choose-and-upload-file.js ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 165:
/*!***************************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-file-picker/components/uni-file-picker/utils.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 173:
/*!******************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-forms/components/uni-forms/validate.js ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 174:
/*!***************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-forms/components/uni-forms/utils.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 203:
/*!***********************************************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 26:
/*!**********************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 37:
/*!***************************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/pages.json?{"type":"origin-pages-json"} ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 38:
/*!**************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/pages.json?{"type":"stat"} ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 45:
/*!************************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/uni.promisify.adaptor.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 52:
/*!**************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/request/api.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.submitComment = void 0;
exports.uniUploadImage = uniUploadImage;
exports.uniUploadMultipleImages = uniUploadMultipleImages;
exports.updateUserInterests = updateUserInterests;
exports.uploadImage = uploadImage;
exports.uploadMultipleImages = uploadMultipleImages;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 28));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 31));
var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 53));
/**
 * 旅游景点智能推荐系统 API 接口
 */
...
var baseURL = 'http://192.168.1.10:8000'; // 使用你的真实局域网IP
 ...
 */
function updateUserInterests(data) {
 ...
 * @returns {Promise} - 返回上传结果
 */
function uniUploadImage(tempFilePath) {
  return new Promise(function (resolve, reject) {
    uni.uploadFile({
      ...
      header: {
        'Content-Type': 'multipart/form-data',
        'Authorization': uni.getStorageSync('token') ? "Bearer ".concat(uni.getStorageSync('token')) : ''
      },
      formData: {},
      // 添加空的formData对象，确保请求格式正确
      success: function success(res) {
 ...
 */
function uniUploadMultipleImages(tempFilePaths) {
  ...
  if (tempFilePaths.length === 1) {
    return uniUploadImage(tempFilePaths[0]).then(function (result) {
      return {
        files: [result]
      };
    });
  ...
  // 多张图片逐个上传
  return new Promise(function (resolve, reject) {
    var uploads = tempFilePaths.map(function (path) {
 ...
 */
function publishComment(commentData) {
  var imagePaths = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var coverImagePath = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(resolve, reject) {
      var uploadedImages, coverImageUrl, imageResult, coverResult, postData, result;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return uniUploadMultipleImages(imagePaths);
            case 7:
              imageResult = _context.sent;
              console.log('【DEBUG】publishComment - 图片上传结果:', imageResult);
              uploadedImages = imageResult.files.map(function (file) {
                return file.url;
              });
            case 10:
              if (!coverImagePath) {
              ...
              _context.next = 14;
              return uniUploadImage(coverImagePath);
            case 14:
              coverResult = _context.sent;
...
var submitComment = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(postId, commentData) {
    var token, response, _response$data;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 5:
            _context2.next = 7;
            return uni.request({
              url: "".concat(baseURL, "/api/posts/").concat(postId, "/comments"),
              method: 'POST',
              data: commentData,
              header: {
          ...
          case 13:
            ...
            throw new Error(((_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.detail) || '评论提交失败');
          case 15:
            _context2.next = 21;
            break;
          case 17:
            ...
            console.error('评论提交异常:', _context2.t0);
            throw _context2.t0;
          case 21:
          case "end":
            return _context2.stop();
  ...
  return function submitComment(_x3, _x4) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 19:
            ...
            console.error('获取评论异常:', _context3.t0);
            return _context3.abrupt("return", []);
          case 23:
          case "end":
            return _context3.stop();
...
/***/ 53:
/*!******************************************************!*\
  !*** I:/基于在线评论的旅游景点智能推荐系统/小程序/前端/request/request.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 响应拦截器
var responseInterceptor = function responseInterceptor(response, requestConfig) {
  // 请求成功
  if (response.statusCode >= 200 && response.statusCode < 300) {
  ...
  if (response.statusCode === 401) {
    ...
    var requestUrl = (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.url) || '';
    var requestMethod = (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.method) || '';
      ...
      uni.request({
        ...
        fail: function fail(err) {
          ...
          if (retryCount < maxRetries && (err.errMsg.includes('timeout') || err.errMsg.includes('fail'))) {
            retryCount++;
            console.log("\u3010DEBUG\u3011request - \u7B2C".concat(retryCount, "\u6B21\u91CD\u8BD5"));
            setTimeout(function () {
