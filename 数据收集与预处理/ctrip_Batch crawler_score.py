"""
@FileName：ctrip_Batch crawler_score.py\n
@Description：机器学习\n
@Author：Surely\n
...
@Author：Surely\n
@Time： 2025 - 01 - 2025/1/27\n
这个版本代码在上一个版本上做了一定改动，爬取内容的同时爬取了得分。
...
# 打开 CSV 文件并准备写入
with open('comments_beijing+score.csv', mode='w', newline='', encoding='utf-8') as file:
    ...
    for business_id in business_ids:
        ...
        for comment in comments:
            ...
            score = comment.get('score', 0)  # 获取评论评分，假设有 score 字段
            if content:  # 如果评论内容不为空
                ...
                # 将评论内容、评分和景点 business_id 写入 CSV 文件
                writer.writerow([business_id, clean_content, score])

print("所有评论已成功保存到 'comments_beijing+score.csv' 文件中！")