...
# 目标景点的 businessId 列表
business_ids = [
    74004, 5382354, 56364, 64504, 1411705, 112796, 758, 69572753, 1830963,10672,10657,112794
]
...
# 打开 CSV 文件并准备写入
with open('comments_all_sights_Tianjing.csv', mode='w', newline='', encoding='utf-8') as file:
...
print("所有评论已成功保存到 'comments_all_sights_Tianjing.csv' 文件中！")