...
# 目标景点的 businessId 列表
business_ids = [
    736, 1412255, 762, 4651499, 740, 3733, 758, 69572753, 137059,1815443,
]
...
# 打开 CSV 文件并准备写入
with open('comments_all_sights_Shanghai.csv', mode='w', newline='', encoding='utf-8') as file:
...
print("所有评论已成功保存到 'comments_all_sights_Shanghai.csv' 文件中！")